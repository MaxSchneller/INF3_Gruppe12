...
extern void F862_6984(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F862_6985(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F862_6986(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		RTCT(NULL, EX_POST);
		ui4_1 = arg1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4915, dtype))(Current, ui4_1x)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
/* {TREES}.insertfunction */
void F862_6984 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
	char *l_feature_name = "insertfunction";
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 861, Current, 3, 2, 12665);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if ((EIF_TRUE)) {
		...
		ui4_1 = arg1;
		ur1 = RTCCL(loc1);
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(4916, dtype))(Current, ui4_1x, ur1x)).it_b);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
...
/* {TREES}.haselementfunction */
EIF_TYPED_VALUE F862_6986 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
	char *l_feature_name = "haselementfunction";
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_REFERENCE loc2 = (EIF_REFERENCE) 0;
#define arg1 arg1x.it_i4
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 861, Current, 2, 2, 12667);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
