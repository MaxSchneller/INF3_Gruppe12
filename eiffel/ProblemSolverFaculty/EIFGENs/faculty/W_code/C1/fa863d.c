...
static const EIF_TYPE_INDEX egt_13_863 [] = {0xFF01,864,0xFFFF};
static const EIF_TYPE_INDEX egt_14_863 [] = {0xFF01,864,0xFFFF};
...
static const struct desc_info desc_863[] = {
	...
	{EIF_NON_GENERIC(0x017F /*191*/), 12649, 8},
	...
	{EIF_GENERIC(egt_13_863), 12657, 0},
	{EIF_NON_GENERIC(0x019D /*206*/), 12658, 12},
	{EIF_NON_GENERIC(0x019D /*206*/), 12651, 16},
	{EIF_GENERIC(NULL), 12652, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_863), 12655, 0xFFFFFFFF},
};
void Init863(void)
{
	IDSC(desc_863, 0, 862);
	IDSC(desc_863 + 1, 1, 862);
	IDSC(desc_863 + 32, 345, 862);
	IDSC(desc_863 + 36, 343, 862);
}
