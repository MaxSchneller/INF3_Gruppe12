...
void egc_init_plug (void)
{
	...
	egc_system_name = "faculty";
	egc_system_location = "D:\\Studium (D)\\Informatik 3 Praktikum\\inf3_Repo\\eiffel\\ProblemSolverFaculty\\EIFGENs\\faculty\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1447925958;
